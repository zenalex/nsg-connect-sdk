...
> **Статус:** в продакшене. На SDK целиком построен клиент Chatista (Windows,
> Android, iOS, web) — переписка, треды, вложения и альбомы, реакции, поиск,
> голосовые сообщения, звонки 1:1, папки чатов, команды и поддержка,
> объявления, обращения с задачами во внешнем трекере.
>
> Эта строка с мая 2026 говорила «TASK11 skeleton, экраны — заглушки» и к
> августу отстала примерно на 340 коммитов — достаточный повод не верить
> статусам на слово и смотреть в [CHANGELOG](CHANGELOG.md) и историю.
