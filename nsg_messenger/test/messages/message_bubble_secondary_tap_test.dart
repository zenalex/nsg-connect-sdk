...
/// гардам (sent + не-tombstone + вне selectionMode). Long-press на мобиле
/// не меняется — right-click добавлен параллельно.
void main() {
  ...
  testWidgets('pending (нет matrixEventId) → правый клик игнорируется', (
    tester,
  ) async {
    var calls = 0;
    await tester.pumpWidget(
